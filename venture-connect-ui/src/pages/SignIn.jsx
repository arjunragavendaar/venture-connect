...
<h2 className="text-center"><b>Login</b></h2>
      ...
      <Button className="mb-3" variant="outline-dark" onClick={save} style={{width:"100%"}}>
        Login
      </Button>
      <span style={{ display: "flex", marginLeft: "30%" }}>Don't have an account?&nbsp;&nbsp;<b style={{ textDecoration: "underline", cursor: "pointer" }}><a style={{color:"gray"}} href="/pages/SignUp">Create an account</a></b></span>
        </Stack>
    </Form>
    </Stack>
  </div>

  ...
  <div>
    ...
    <Form.Group className="mb-3" controlId="designation">
     <Form.Label>Designation</Form.Label>
        <Form.Control type="text" value={designationValue} onChange={handleDesignationChange} placeholder="Eg: Product Manager,General Manager" />
        </Form.Group>
    ...
    <Form.Group className="mb-3" controlId="formexperience">
     ...
     <Form.Label>Area of expertise</Form.Label>
        <Form.Control type="text" value={expertiseValue} onChange={handleExpertiseChange} placeholder="Eg: Finance and E-commerce, Supply chain and logistics" />
        </Form.Group>
